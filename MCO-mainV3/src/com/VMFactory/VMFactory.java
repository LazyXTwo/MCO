...
public class VMFactory {
    ...
    public static void main(String args[]) {
        ...
        Machine regVendingMachine = new RVMachine();
        String strAnswer;
        double dAnswer;
            ...
            switch (nChoice_MainMenu) {
                case 1:
                    do {
                        ...
                        VMFactory.print(new ArrayList<String>(Arrays.asList("Regular Vending Machine",
                ...
                case 2:
                    if (bChoice_MachineType == false) {
                        factory.flush();
                        System.out.print(
                                "ERROR : An existing vending machine instance is required to use this feature.\n\nPress enter to continue.");
                        factory.next();
                    } else {
                        do {
                            factory.flush();
                            System.out.println(">> Feature Testing Menu\n Please select the machine feature to test.");
                            VMFactory.print(new ArrayList<String>(
                                    Arrays.asList("Vending Features", "Maintenance Features", "Return to Main Menu")));
                            System.out.print("\nEnter choice : ");
                            ...
                            switch (nChoice_MachineFeature) {
                                    ...
                                    if (regVendingMachine.getItemListSize() < 8) {
                                        ...
                                        for (int i = 0; i < regVendingMachine.getItemListSize(); i++)
                                            System.out.println("[" + ++i + "]\tItem Name : "
                                                    ...
                                                    + regVendingMachine.getItemPrice(i) + "\tCaloric Value : "
                                                    + regVendingMachine.getItemCaloricValue(i) + "\tQuantity : "
                                                    + regVendingMachine.getItemQuantity(i));
                                        System.out.print("\n\nEnter item index : ");
                                        nChoice_ItemSelection = sc.nextInt() - 1;
                                        if (nChoice_ItemSelection < 0
                                                || regVendingMachine.getItemListSize() <= nChoice_ItemSelection) {
                                            do {
                                                factory.flush();
                                                System.out.println(
                                        ...
                                        do {
                                            ...
                                            for (int i = 0; i < regVendingMachine.getChangeFundSize(); i++)
                                                System.out.println("[" + ++i + "]" + "   Amount : "
                                                        + regVendingMachine.getChangeFundAmount(--i) + "\tCount : "
                                                ...
                                                do {
                                                    ...
                                                    for (int i = 0; i < regVendingMachine.getChangeFundSize(); i++)
                                                        System.out.println("[" + ++i + "]" + "   Amount : "
                                                                ...
                                                                + "\tCount : " + regVendingMachine.getPaymentCount(i));
                                                    System.out.print("\nEnter denomination index : ");
                                                    nAnswer1 = sc.nextInt() - 1;
                                                } while (nAnswer1 < 0
                                        ...
                                        if (regVendingMachine.checkChangeFund(regVendingMachine.getPaymentBalance()
                                                - regVendingMachine.getItemPrice(nChoice_ItemSelection)) == true) {
                                            factory.flush();
                                            regVendingMachine.finalizePayment();
                                            regVendingMachine.dispenseItem(nChoice_ItemSelection);
                                            System.out.print(regVendingMachine.getItemName(nChoice_ItemSelection)
                                ...
                                case 2:
                                    do {
                                        ...
                                        VMFactory.print(new ArrayList<String>(Arrays.asList("List All Existing Items",
                                                "Stock/Restock Items", "Collect Payment", "View Change Fund Inventory",
                                                "Replenish Change Fund Inventory", "Print a Summary of Transactions",
                                                "Return to Main Menu")));
                                        System.out.print("\nEnter choice : ");
                                        ...
                                        switch (nChoice_MaintenanceFeature) {
                                            ...
                                            case 2:
                                                do {
                                                    ...
                                                    VMFactory.print(new ArrayList<String>(Arrays.asList(
                                                    ...
                                                    switch (nChoice_Stocking) {
                                                        case 1:
                                                            ...
                                                            if (regVendingMachine.stockItem(strAnswer, dAnswer,
                                                                    nAnswer1, nAnswer2) == true) {
                                                                factory.flush();
                                                                System.out.print(
                                            ...
                                            case 3:
                                                factory.flush();
                                                System.out.print("SUCCESS : " + regVendingMachine.collectMoney()
                                            ...
                                            case 6:
                                                ...
                                                for (int i = 0; i < regVendingMachine.getItemListSize(); i++)
                                                    System.out.println("Item Name : " + regVendingMachine.getItemName(i)
                                                            + "\tPrice : " + regVendingMachine.getItemPrice(i)
                                                            + "\tOriginal Quantity since Last Restock : "
                                                            + regVendingMachine.getTransactionSummaryQuantity(i)
                                                            + "\tCurrent Quantity : "
                                                            + regVendingMachine.getItemQuantity(i));
                                                System.out.print("--end of list--\n\nPress enter to continue.");
                                                factory.next();
